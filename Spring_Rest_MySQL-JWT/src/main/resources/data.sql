...
INSERT INTO `piezas_proveedores`.`proveedores` (`Id`, `Nombre`) VALUES ("abcd", "AMD");
INSERT INTO `piezas_proveedores`.`suministra` (`Id`, `CodigoPieza`, `IdProveedor`, `Precio`) VALUES (1, 1, "abcd", 400);
